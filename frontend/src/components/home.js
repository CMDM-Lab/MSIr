        ...
        <div class="challange_text_inner">
          <div class="l_title">
            <span class="fa-stack fa-2x">
              <i class="fad fa-square fa-stack-2x" data-fa-transform="rotate-60" style="--fa-primary-color:#A268C6; --fa-secondary-color: #A268C6"></i>
              <i class="fad fa-square fa-stack-2x fa-inverse" data-fa-transform="rotate-30 shrink-1 left-1" style="--fa-primary-color:#72BBDE; --fa-secondary-color: #72BBDE"></i>
            </span>
