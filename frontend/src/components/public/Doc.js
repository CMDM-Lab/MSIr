                      ...
                      <div className='card' style={{'width':'100%'}}>
                        <div className='card-body'>  
                          ...
                          <dl>
                            ...
                            <dd>- The uplaoded data, registrations, and extractions are stored in dataset</dd>
                            <dt>Upload MSI data</dt>
                            <dd>- Upload centroided imzML format data (available format: *.imzML & *.ibd; size limitation: 100 MB) </dd>
                            ...
                            <dd>- Upload the histological image (available format: *.png, *.jpg, *.jpeg ; size limitation: 100 MB)</dd>
                            {/* <dd>- Set Spatial Resolution (optional)<br/>
                            <p style = {{color:'red'}}>  If the Spatial Resolutions of MSI data and histology are both set, the scale factor is calculated based on Spatial Resolution</p>
                            </dd> */}
