...
const RegistrationItem = ({datasetId, registration})=>{
    ...
    return (
        <tr key={registration.id}>
            <td>
                <a className="btn btn-dark" href={`/datasets/${datasetId}/registrations/${registration.id}`}>
                    ID: {registration.id}
                </a><br />
                <br />
            ...
            <td>
                <div className="btn-group">
                    ...
                    <button className="delete-object btn btn-outline-dark col-lg-6 col-6" onClick={handleDelete} disabled={registration.status === 'running'}>Delete</button>
                </div>
            </td>
        </tr>
    )
