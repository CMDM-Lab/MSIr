          ...
          <div className="row">
            ...
            <div className="col-lg-6 col-6" style={{paddingLeft: 0}}>
              <ol className="breadcrumb">
                ...
                <li className="breadcrumb-item active"><a href="/registrations">Registrations</a></li>
              </ol>
            </div>
          </div>
          <div className="row">
              ...
              <table className="table">
                <thead>
                  <tr>
                    ...
                    <th width="20%">Mask Image</th>
                    <th width="20%">Histology Image</th>
                    <th width="20%">Evaluation Image</th>
                    <th>Status</th>
